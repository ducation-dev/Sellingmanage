package com.example.banhang.SQLServerManagement;
...
public class SQLServerHelper {
    private static String sql = "jdbc:jtds:sqlserver://192.168.1.34:1433;databasename=BANHANG;user=CNPM;password=nguyenduc123"; // dia chi ket noi
